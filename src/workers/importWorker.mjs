...
import { Let, WorkerMainThread, Q } from 'virst';
 ...
 * @returns {Promise<{worker:Worker, resultSignal:import('virst').Let<workerType<T>['post']['main']>, postMessage:(message: workerType<T>['receive']['main'], options?: StructuredSerializeOptions)=>void}>}
